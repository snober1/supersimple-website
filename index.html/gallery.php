...
<div class="nav">
    ...
    <div class="cats">
    <a href="add_gallery.php">Add New Product</a>
    </div>
</div>
<!--dashboard heading in content-->
<div class="dashboard">
        <i><ion-icon name="home-outline"></ion-icon></i>
        <span>Home     /      Manage Gallery </span>
    </div>
  ...
  <th>DESCRIPTION</th>
  <th>IMAGE</th>
  <th style="margin-left: 1.5%; margin-top: 1%; position: absolute;">STATUS</th>
   </tr>
   <?php 
...
<tr>
  ...
  <td><a href="delete.php?id=<?php echo $row['id']; ?>"><button style="cursor: pointer;" type="submit" name="delete" onClick="alert('Delete a Record')">Delete</button></a></td>
  <td><a href="update_gallery.php?id=<?php echo $row['id']; ?>"><button type="submit" name="update" onClick="alert(' Update a Record.')" style="width: 90%; margin-left: 3%; cursor: pointer;">Update</button></a></td>
   </tr>
   <?php } ?>
  </table>
    </div><!--echo/table div end-->
    </div><!--register end-->
