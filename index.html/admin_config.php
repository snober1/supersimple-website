...
<div class="dashboard">
        <i><ion-icon name="home-outline"></ion-icon></i>
        <span>Home     /     Update Site Configuration</span>
    </div>
...
while($row=mysqli_fetch_array($query)){?>
        <!--FORM DETAILS OF SITES configuration-->
        <form action="#" method="POST">
     
        <label>Page Title</label>
        <input type="text" name="name" value="<?php echo $row['page_title']; ?>" placeholder="Enter Name" required/>
     
     
        <label>Meta Keywords</label>
        <input style="margin-left: 6.5%;" type="text" value="<?php echo $row['meta_keyword']; ?>" name="keyword" placeholder="Enter Meta Keyword" required/>
     
     
        <label style="margin-top: 17%; margin-left: -91%; position: absolute;">Description</label>
        <textarea  style="margin-left: 28%;" value="<?php echo $row['description']; ?>" type="message" rows="3" cols="570" name="description" placeholder="Enter Descripter" required></textarea> 
     
     
        <label>Product Per Page</label>
        <input style="margin-left: 4.6%;" type="number" value="<?php echo $row['product_per_page']; ?>" name="per_page" placeholder="Enter Product Per Page" required/>
     
     
        <label style="margin-top: 13.5%; margin-left: -92%; position: absolute;">No. of home product</label>
        <input style="margin-left: 29%;" value="<?php echo $row['home_product']; ?>" type="number" name="home_pro" placeholder="Enter No. of home product" required/>
     
     
        <label style="margin-top: 13.5%; margin-left: -92%; position: absolute;">No. of related Product</label>
        <input style="margin-left: 29%;" value="<?php echo $row['related_product']; ?>" type="number" name="rel_pro" placeholder="Enter No. of related Product" required/>
     
     
        <label style="margin-top: 13.5%; margin-left: -92%; position: absolute;">Email</label>
        <input style="margin-left: 29%;" type="email" value="<?php echo $row['email']; ?>" name="email" placeholder="Enter Email" required/>
     
     
        <label style="margin-top: 13.5%; margin-left: -92%; position: absolute;">Phone Number</label>
        <input style="margin-left: 29%;" value="<?php echo $row['phone_number']; ?>" type="int" name="phoneno" placeholder="Enter Phone Number" required/>
     
     
        <label style="margin-top: 17.5%; margin-left: -92%; position: absolute;">Footer Contact</label>
        <textarea  style="margin-left: 28%;" value="<?php echo $row['footer_contact']; ?>" type="message" rows="3" cols="570" name="footer_cont" placeholder="Message " required></textarea> 
     
     
        <label style="margin-top: 18.5%; margin-left: -90.5%; position: absolute;">Company Name</label>
        <input  style="margin-left: 29%;" value="<?php echo $row['company_name']; ?>" type="name" name="comapny" placeholder="Enter Company Name" required/>
     
     
        <label style="margin-top: 13.5%; margin-left: -92%; position: absolute;">Facebook</label>
        <input style="margin-left: 29%;" value="<?php echo $row['facebook']; ?>" type="link" name="fb" placeholder="Enter Facebook Link" required/>
     
     
        <label style=" margin-top: 13.5%; margin-left: -92%; position: absolute;">Twitter</label>
        <input style="margin-left: 29%;" value="<?php echo $row['twitter']; ?>" type="link" name="twitter" placeholder="Enter Twitter Link" required/>
     
     
        <label style=" margin-top: 13.5%; margin-left: -92%; position: absolute;">Instagram</label>
        <input style="margin-left: 29%;" value="<?php echo $row['instagram']; ?>" type="link" name="insta" placeholder="Enter Instagram Link" required/>
     
     
        <label style=" margin-top: 18.5%; margin-left: -92%; position: absolute;">Footer Legal Text</label>
        <textarea  style="margin-left: 29%;" value="<?php echo $row['footer_legal_text']; ?>" type="legal_text" rows="3" cols="570" name="message" placeholder="Message " required></textarea> 
