...
<div class="nav">
    ...
    <div class="cats">
    <a href="add_pages.php">Add New Pages</a>
    </div>
</div>
<!--dashboard heading in content-->
<div class="dashboard">
        <i><ion-icon name="home-outline"></ion-icon></i>
        <span>Home     /      Manage Pages </span>
    </div>
    <!-- main content registration/contact us data-->
   
    <div class="register">
   <!---table and acho stqart data show on browser from db--->
    <div class="echo">
  ...
  <th  style="margin-left: 11%; margin-top: 4%; position: absolute;">STATUS</th>
   </tr>
   <?php 
    include ("connection.php");
 $a=mysqli_query($connect, "SELECT * FROM page order by id");
    while($row=mysqli_fetch_array($a)){?>
<tr>
  <td style="text-align: center;"><?php echo $row['id']; ?></td>
  <td style="text-align: center;"><?php echo $row['name']; ?></td>

  <td><a href="page_del.php?id=<?php echo $row['id'];?>"><button type="submit" name="delete">Delete</button></a></td>
  <td><a href="#.php?id=<?php echo $row['id'];?>"><button type="submit" name="edit" style="width: 90%; margin-left: 3%;">Update</button></a></td>
   </tr>
   <?php } ?>
  </table>
    </div>
