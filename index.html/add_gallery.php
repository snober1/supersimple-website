...
<div class="dashboard">
        <i><ion-icon name="home-outline"></ion-icon></i>
        <span>Home     /     Add New Product</span>
    </div>
    <!-- main content registration/contact us data-->
    <div class="register">
        <div class="box">
            <!--add gallery img action-->
            <!-- insert data action file name is img_action -->
        <form action="img_action.php" method="POST">
    <div class="field">
 ...
 <div class="pros_formss" style="  margin-left: -82%;">
  ...
  <input type="file" accept="jpga, web, png, jpg" name="file" placeholder="" required/>
 </div>
